            ...
            while(true){
                ...
                if(board_[new_position].first == opponent) {
                    if (board_[new_position].second == Pieces::bishop || board_[new_position].second == Pieces::queen) {
                        if (!pin_pieces_found) num_check++;
                        else king_attacked_info_.set(pin_piece_position);
                    }
                    break;
                }
...
void ChessEnv::showMoveInfo(int from, int to, Pieces move, Pieces take, Pieces promote) {
    ...
    if (move == Pieces::pawn) std::cout << "move[pawn] ";
    else if (move == Pieces::knight) std::cout << "move[knight] ";
    else if (move == Pieces::bishop) std::cout << "move[bishop] ";
    else if (move == Pieces::rook) std::cout << "move[rook] ";
    else if (move == Pieces::queen) std::cout << "move[queen] ";
    else std::cout << "move[king] ";

    if (take == Pieces::pawn) std::cout << "take[pawn] ";
    else if (take == Pieces::knight) std::cout << "take[knight] ";
    else if (take == Pieces::bishop) std::cout << "take[bishop] ";
    else if (take == Pieces::rook) std::cout << "take[rook] ";
    else if (take == Pieces::queen) std::cout << "take[queen] ";
    else std::cout << "take[empty] ";

    if (promote == Pieces::knight) std::cout << "promote[knight]\n";
    else if (promote == Pieces::bishop) std::cout << "promote[bishop]\n";
    else if (promote == Pieces::rook) std::cout << "promote[rook]\n";
    else if (promote == Pieces::queen) std::cout << "promote[queen]\n";
    else std::cout << "promote[empty]\n";
}
...
bool ChessEnv::act(const ChessAction& action) {
    ...
    if (plyIsCheck(turn_) == true) {
        std::cout << toString();
        if (turn_ == Player::kPlayer1) std::cout << "White ";
        else std::cout << "Black ";
